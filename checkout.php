...
<head>
    ...
    <link href="css/LKetTKhoan.css" rel="stylesheet">
</head>
<body>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        <ul class="list-unstyled">
                                            <li>
                                                <label class="custom-control custom-radio m-b-20" style="display: flex; align-items: center; justify-content: flex-start;">
                                                    <input name="mod" id="radioStacked1" checked value="COD" type="radio" class="custom-control-input"> 
                                                    <span class="custom-control-indicator"></span> 
                                                    <span class="custom-control-description" style="display: flex; align-items: center;">
                                                        <img src="images/tienmat.png" alt="Cash on Delivery" style="height: 24.2px; width: 32.9px; margin-right: 5px;">
                                                        Cash on Delivery
                                                    </span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-radio m-b-20" style="display: flex; align-items: center; justify-content: flex-start;">
                                                    <input name="mod" id="radioStacked2" value="momo" type="radio" class="custom-control-input"> 
                                                    <span class="custom-control-indicator"></span> 
                                                    <span class="custom-control-description" style="display: flex; align-items: center;">
                                                        <img src="images/momo.png" alt="MoMo" style="height: 24.2px; width: 32.9px; margin-right: 5px;">
                                                        MoMo
                                                    </span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="custom-control custom-radio m-b-10" style="display: flex; align-items: center; justify-content: flex-start;">
                                                    <input name="mod" id="radioStacked3" value="zalopay" type="radio" class="custom-control-input"> 
                                                    <span class="custom-control-indicator"></span> 
                                                    <span class="custom-control-description" style="display: flex; align-items: center;">
                                                        <img src="images/zalopay.png" alt="ZaloPay" style="height: 24.2px; width: 32.9px; margin-right: 5px;">
                                                        ZaloPay
                                                    </span>
                                                </label>
                                            </li>
