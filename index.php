...
<head>
  ...
  $(document).ready(function() {
    // Khởi tạo hiệu ứng rơi ngôi sao
    jQuery(document).snowfall({
      image: "images/star.png", // Đường dẫn tới hình ảnh ngôi sao
      maxFlakes: 100, 
      minSize: 5, 
      maxSize: 10 
    });
...
<body class="home">
    ...
    <section class="hero them bg-image"  >
    ...
    <section class="con">
		<div id="my-carousel">
			<figure><img src="./admin/Res_img/dishes/spicy.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/pỏtuguese.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/mocha.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/matcha.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/machadonut.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/flosspatefilling.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/daudonut.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/croissant.jpg" alt=""></figure>
			<figure><img src="./admin/Res_img/dishes/banh2.jpg" alt=""></figure>
		</div>
	</div>
    </section>
    ...
    <section class="featured-restaurants">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <div class="title-block pull-left">
                        <li class="nav-item"> <a class="nav-link active" href="q.ao.php"> Event <span class="sr-only"></span></li>
                    </div>
